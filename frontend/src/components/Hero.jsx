  ...
  return (
    <section className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl mb-8 mt-6 border border-gray-200 dark:border-gray-700">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8 p-8">
        <img src={movie.movie_photo_path} alt={movie.movie_title} className="rounded-2xl shadow-lg w-56 h-80 object-cover border-4 border-white/40" />
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2 text-lg">{movie.movie_genre && movie.movie_genre.join(' • ')}</p>
